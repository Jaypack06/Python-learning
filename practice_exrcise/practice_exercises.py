...
def practice_5a_beginner():
    ...
    for char in email: 
        if char == '@':
            ...
            counter += 1 
    username = email[0:counter]  
    
    # TODO 4: Get domain (everything after @)
    domain = email[counter:]  
...
def practice_6_final_project():
    ...
    less_space = sample_text.strip()
    # - Replace multiple spaces with single space
    less_space = less_space.replace("   ", " ")
    # Step 2: Standardize case
    # - Sentences should be properly capitalized
    sentences = less_space.split(". ")
